...
class Referrer(models.Model):
    ...
    campaign = models.ForeignKey(Campaign, verbose_name=_("Campaign"), related_name='referrers', blank=True, null=True, on_delete=models.DO_NOTHING)
...
class UserReferrer(models.Model):
    ...
    referrer = models.ForeignKey(Referrer, verbose_name=_("Referrer"), related_name='users', on_delete=models.DO_NOTHING)
